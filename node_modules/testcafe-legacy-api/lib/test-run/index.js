...
ServiceMessages[command_1.default.fatalError] = function (msg) {
    return this._fatalError(msg.err);
};
ServiceMessages[command_1.default.assertionFailed] = function (msg) {
    return this._addError(msg.err);
};
ServiceMessages[command_1.default.done] = function () {
    this.emit('done');
};
ServiceMessages[command_1.default.setStepsSharedData] = function (msg) {
    this.stepsSharedData = msg.stepsSharedData;
};
ServiceMessages[command_1.default.getStepsSharedData] = function () {
    return this.stepsSharedData;
};
ServiceMessages[command_1.default.getAndUncheckFileDownloadingFlag] = function () {
    var isFileDownloading = this.isFileDownloading;
    this.isFileDownloading = false;
    return isFileDownloading;
};
ServiceMessages[command_1.default.waitForFileDownload] = function () {
    // NOTE: required to keep API similar to TestRun. Just do nothing here.
};
ServiceMessages[command_1.default.nativeDialogsInfoSet] = function (msg) {
...
ServiceMessages[command_1.default.takeScreenshot] = async function (msg) {
    try {
