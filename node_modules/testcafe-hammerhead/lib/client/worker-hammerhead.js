(function () {
	...
	function parseUrl$1(url) {
	    ...
	    var remainder = url
	        .replace(PROTOCOL_RE, function (_str, protocol, strAfterProtocol) {
	    ...
	    parsed.partAfterHost = remainder
	        .replace(HOST_RE, function (_str, host, restPartSeparator) {
	        parsed.host = host;
	        parsed.port = '';
	...
	***************************************************************************** */
	...
	var NativeMethods = /** @class */ (function () {
	    ...
	    NativeMethods.prototype.refreshIfNecessary = function (doc, win) {
	        ...
	        var needToRefreshDocumentMethods = tryToExecuteCode(function () { return !doc.createElement ||
