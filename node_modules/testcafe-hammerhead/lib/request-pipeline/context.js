...
class RequestPipelineContext {
    constructor(req, res, serverInfo) {
        ...
        this.parsedClientSyncCookie = req.headers.cookie && cookie_1.parseClientSyncCookieStr(req.headers.cookie);
    }
    ...
    async _getDestResBody(res) {
        if (incoming_message_like_1.default.isIncomingMessageLike(res))
            return res.getBody();
        return http_1.fetchBody(this.destRes);
    }
