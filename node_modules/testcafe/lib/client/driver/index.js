...
(function () {
    ...
    ***************************************************************************** */
    ...
    function evalFunction(fnCode, __dependencies$) {
        var evaluator = new hammerhead.nativeMethods.Function('fnCode', '__dependencies$', 'Promise', 
    ...
    var SelectorExecutor = /** @class */ (function (_super) {
        ...
        function SelectorExecutor(command, globalTimeout, startTime, createNotFoundError, createIsInvisibleError) {
            ...
            if (startTime) {
                var elapsed = new DateCtor() - startTime;
        ...
        SelectorExecutor.prototype._validateElement = function (args, startTime) {
            ...
            return hammerhead.Promise.resolve()
                ...
                var isTimeout = new DateCtor() - startTime >= _this.timeout;
                if (isElementExists && (isElementVisible || testCafeCore.domUtils.isShadowRoot(el)))
                    return el;
                if (!isTimeout)
    ...
    var ElementsRetriever = /** @class */ (function () {
        function ElementsRetriever(elementDescriptors, globalSelectorTimeout) {
            ...
            this.ensureElementsStartTime = new DateCtor$1();
    ...
    var Driver = /** @class */ (function (_super) {
        ...
        Driver.prototype._onExecuteSelectorCommand = function (command) {
            var _this = this;
            var startTime = this.contextStorage.getItem(SELECTOR_EXECUTION_START_TIME) || new DateCtor$3();
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            wnd = this._getTopOpenedWindow();
                            return [4 /*yield*/, this._validateChildWindowSwitchToWindowCommandExists({ windowId: command.windowId, fn: command.findWindow }, wnd)];
                        case 1:
                            response = _a.sent();
                            result = response.result;
                            if (!result.success) {
        ...
        Driver.prototype._setupAssertionRetryIndication = function () {
            ...
            this.readyPromise.then(function () {
                ...
                if (assertionRetriesTimeout) {
                    ...
                    var timeLeft = assertionRetriesTimeout - (new DateCtor$3() - startTime);
                    if (timeLeft > 0)
