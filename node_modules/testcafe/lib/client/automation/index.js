...
(function () {
    function initTestCafeAutomation(window, isIFrameWithoutSrc) {
        ...
        (function (hammerhead, testCafeCore, Promise$f, testCafeUI) {
    ...
    ***************************************************************************** */
    ...
    function sendRequestToFrame$1(msg, responseCmd, receiverWindow) {
        return new Promise$4(function (resolve) {
            function onMessage(e) {
                if (e.message.cmd === responseCmd) {
                    messageSandbox$2.off(messageSandbox$2.SERVICE_MSG_RECEIVED_EVENT, onMessage);
                    resolve(e.message);
                }
            }
            messageSandbox$2.on(messageSandbox$2.SERVICE_MSG_RECEIVED_EVENT, onMessage);
            messageSandbox$2.sendServiceMsg(msg, receiverWindow);
        });
    }
    ...
    messageSandbox$3.on(messageSandbox$3.SERVICE_MSG_RECEIVED_EVENT, function (e) {
        if (e.message.cmd === GET_IFRAME_REQUEST_CMD) {
            var iframeElement = domUtils$3.findIframeByWindow(e.source);
            focusBlurSandbox.focus(iframeElement, function () {
                messageSandbox$3.sendServiceMsg({ cmd: GET_IFRAME_RESPONSE_CMD }, e.source);
            }, false);
        }
    });
    ...
    function focusAndSetSelection(element, simulateFocus, caretPos) {
        var _this = this;
        return new Promise$5(function (resolve) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, sendRequestToFrame$1({ cmd: GET_IFRAME_REQUEST_CMD }, GET_IFRAME_RESPONSE_CMD, window.parent)];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2:
                        activeElement = domUtils$3.getActiveElement();
                        isTextEditable = domUtils$3.isTextEditableElement(element);
                        labelWithForAttr = domUtils$3.closest(element, 'label[for]');
                        isElementFocusable = domUtils$3.isElementFocusable(element);
                        shouldFocusByRelatedElement = !isElementFocusable && labelWithForAttr;
                        isContentEditable = domUtils$3.isContentEditableElement(element);
                        ...
                        if (!isElementFocusable && !isContentEditable) {
                            curDocument = domUtils$3.findDocument(elementForFocus);
                            curActiveElement = nativeMethods$4.documentActiveElementGetter.call(curDocument);
                            isActiveElementBody = domUtils$3.isBodyElement(curActiveElement);
                            focusableParent = domUtils$3.isBodyElement(elementForFocus) ?
    ...
    var ClickAutomation = /** @class */ (function (_super) {
        ...
        ClickAutomation.prototype.run = function (useStrictElementCheck) {
            ...
            return this
                ...
                return Promise$6.all([delay(_this.automationSettings.mouseActionStepDelay), _this._mousedown(eventArgs)]);
            })
    ...
    var PressAutomation = /** @class */ (function () {
        ...
        PressAutomation.prototype.run = function () {
            ...
            if (!isIframeWindow(window) && activeElementIsIframe && nativeMethods$8.contentWindowGetter.call(activeElement)) {
                var msg = {
...
}(window['%hammerhead%'], window['%testCafeCore%'], window['%hammerhead%'].Promise, window['%testCafeUI%']));
