...
(function () {
    ...
    ***************************************************************************** */
    ...
    function __awaiter(thisArg, _arguments, P, generator) {
        ...
        return new (P || (P = Promise$6))(function (resolve, reject) {
    ...
    var TEMPLATES = (_a = {},
        ...
        _a[RUNTIME_ERRORS.testRunRequestInDisconnectedBrowser] = '"{browser}" has disconnected during test execution',
        _a[RUNTIME_ERRORS.cannotEstablishBrowserConnection] = 'Unable to establish one or more of the specified browser connections.',
        ...
        _a[RUNTIME_ERRORS.uncaughtErrorInReporter] = 'An uncaught error occurred in the "{reporterName}" reporter\'s "{methodName}" method. Error details:\n{originalError}',
        ...
        _a[RUNTIME_ERRORS.typeScriptCompilerLoadingError] = 'Unable to load the TypeScript compiler.\n{originErrorMessage}.',
        ...
        _a[BrowserConnectionErrorHint$1.TooHighConcurrencyFactor] = 'The error can be due to a concurrency factor that is too high for the host machine’s performance (the factor value {concurrencyFactor} was specified). ' +
            'Try to decrease the concurrency factor or ensure more system resources are available on the host machine.',
        _a[BrowserConnectionErrorHint$1.UseBrowserInitOption] = 'Use the "browserInitTimeout" option to allow more time for the browser to start. The timeout is set to {browserInitTimeoutMsg}.',
        _a[BrowserConnectionErrorHint$1.RestErrorCauses] = 'The error can also be caused by network issues or remote device failure. Make sure that the connection is stable and the remote device can be reached.',
        _a);
    ...
    //Utils
    function delay$1(ms) {
        return new Promise$6(function (resolve) { return setTimeout(resolve, ms); });
    }
